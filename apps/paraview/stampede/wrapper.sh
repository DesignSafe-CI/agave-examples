# VNC/Paraview wrapper for DesignSafe on Stampede
...
# run an xterm for the user; execution will hold here; launch paraview as well
xterm -r -ls -geometry 80x24+10+10 -title '*** Exit this window to kill your VNC server ***' -e '/work/00849/tg458981/stampede/DesignSafe/paraview/ParaView-5.0.1-Qt4-OpenGL2-MPI-Linux-64bit/bin/paraview'
